% Statistical Analysis of Evoked Response
% -----------------------------------------------------------------------
% Score response y from unperturbed distribution x
% 
% [score,pval,obs,asindiff,null] = SAER( x, y, niter )

function [score,pval,obs,mdiff,null] = SAER( x, y, niter )
if nargin < 3
	niter = 1000;
end
